...
#define FWD_FORMAT_COMMAND_GET_PROPERTY "%"PRIu32"%s%s%s%s"
#define FWD_FORMAT_COMMAND_GET_PROPERTY_READ "%"PRIu32"%ms%ms%ms"
#define FWD_FORMAT_COMMAND_HELP "%"PRIu32"%s%s"
...
#define FWD_FORMAT_ANSWER_GET_PROPERTY "%"PRIu32"%s"
...
#define FWD_FORMAT_ANSWER_PROPERTY_SET "%"PRIu32"%s"
...
#define FWD_FORMAT_ANSWER_BYEBYE "%"PRIu32"%s"
#define FWD_FORMAT_ANSWER_DEAD "%"PRIu32"%s"
#define FWD_FORMAT_ANSWER_DROPPED "%"PRIu32"%s"
#define FWD_FORMAT_ANSWER_PREPARED "%"PRIu32"%s"
#define FWD_FORMAT_ANSWER_PREPARE_PROGRESS "%"PRIu32"%s"
#define FWD_FORMAT_ANSWER_STARTED "%"PRIu32"%s"
